package edu.cgu.ist380.alkhalir.TestPassingValues;
...
public class MainActivity extends Activity {
   ...
   public void onCreate(Bundle savedInstanceState) {
       ...
       Button mainNext = (Button) findViewById(R.id.AgedDisplay);
       ...
       mainNext.setOnClickListener(new OnClickListener() {
           public void onClick(View v) {
               ...
               Intent i = new Intent();
               i.setClassName("edu.cgu.ist380.alkhalir.TestPassingValues", "edu.cgu.ist380.alkhalir.TestPassingValues.display");
               i.putExtra("Age", age1);
